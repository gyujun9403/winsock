...
namespace WASAuth
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<IAuthorizationHandler, IsNotBlackListHandler>(); 
        }
